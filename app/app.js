const completeData = {
  ...
  "suborgs": [
      {
          "suborgId": 4,
          "suborgName": "Aeronautics Research",
          "orgId": 2,
          "totalFacilities": null,
          "facilities": [
              {
                  "facilityId": 3,
                  "facilityName": "Langley Research Center",
                  "suborgId": 4,
                  "orgId": 2
              },
              {
                  "facilityId": 4,
                  "facilityName": "Armstrong Flight Research Center",
                  "suborgId": 4,
                  "orgId": 2
              },
              {
                  "facilityId": 5,
                  "facilityName": "Stennis Space Center",
                  "suborgId": 4,
                  "orgId": 2
              }
          ]
      ...
      {
          "suborgId": 5,
          "suborgName": "Space Technology",
          "orgId": 2,
          "totalFacilities": null,
          "facilities": [
              {
                  "facilityId": 1,
                  "facilityName": "Jet Propulsion Lab",
                  "suborgId": 5,
                  "orgId": 2
              },
              {
                  "facilityId": 2,
                  "facilityName": "Kennedy Space Center",
                  "suborgId": 5,
                  "orgId": 2
              },
              {
                  "facilityId": 89,
                  "facilityName": "test BE",
                  "suborgId": 5,
                  "orgId": 2
              },
              {
                  "facilityId": 90,
                  "facilityName": "asdfasv",
                  "suborgId": 5,
                  "orgId": 2
              },
              {
                  "facilityId": 91,
                  "facilityName": "5th facility",
                  "suborgId": 5,
                  "orgId": 2
              },
              {
...
const dataSet = [
  ["4","Aeronautics Research", "N/A"],
  ["5","Space Technology", "N/A"]
];
...
.service('FacilitiesService', FacilitiesService)
